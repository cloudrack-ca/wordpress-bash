...
echo -e "${YELLOW}Enter PHP version (e.g. 8.1) [default: 8.1]: ${NC}"
read -p "(default: 8.1) " php_version
php_version=${php_version:-8.1}
echo -e "${GREEN}Using PHP version: $php_version${NC}"

# Prompt user to define WordPress version
echo -e "${YELLOW}Enter WordPress version (e.g. latest) [default: latest]: ${NC}"
...
echo -e "${YELLOW}Enter WordPress directory (e.g. /var/www/html/wordpress) [default: /var/www/html/wordpress]: ${NC}"
...
echo -e "${YELLOW}Enter MySQL root password [default: root]: ${NC}"
...
echo -e "${YELLOW}Enter WordPress database name [default: wordpress_db]: ${NC}"
...
echo -e "${YELLOW}Enter WordPress database user [default: wordpress_user]: ${NC}"
...
echo -e "${YELLOW}Enter WordPress database user password [default: password]: ${NC}"
...
echo -e "${YELLOW}Database name:${NC} $wp_db_name"
echo -e "${YELLOW}Database user:${NC} $wp_db_user"
echo -e "${YELLOW}Database user password:${NC} $wp_db_password"
